...
import com.deep.model.StudentCredential;
...
public class MyController {
	...
	public ModelAndView loginSuccess(@Valid @ModelAttribute("studentCredential") 
	StudentCredential studentCredential,BindingResult bindingResult){
		if(bindingResult.hasErrors()){
	...
	public ModelAndView profile(StudentCredential studentCredential, BindingResult bindingResult) {
		ModelAndView modelAndView = new ModelAndView("welcome");
	...
	public void headerMessage(Model model){
		model.addAttribute("headerMessage", "Welcome to Deep Technology");
